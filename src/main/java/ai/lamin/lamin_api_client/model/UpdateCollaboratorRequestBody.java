...
public class UpdateCollaboratorRequestBody {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("role", "account_id", "team_id"));
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateCollaboratorRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateCollaboratorRequestBody is not found in the empty JSON string", UpdateCollaboratorRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateCollaboratorRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateCollaboratorRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
