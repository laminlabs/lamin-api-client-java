...
public class AddOrganizationMemberRequestBody {
  ...
  private ORGANIZATION role = ORGANIZATION.MEMBER;

  public AddOrganizationMemberRequestBody() {
  }

  public AddOrganizationMemberRequestBody role(@javax.annotation.Nullable ORGANIZATION role) {
    this.role = role;
    return this;
  }

  /**
   * Organization role for the member.
   * @return role
   */
  @javax.annotation.Nullable
  ...
  public void setRole(@javax.annotation.Nullable ORGANIZATION role) {
    this.role = role;
  }
  ...
  public boolean equals(Object o) {
    ...
    AddOrganizationMemberRequestBody addOrganizationMemberRequestBody = (AddOrganizationMemberRequestBody) o;
    return Objects.equals(this.role, addOrganizationMemberRequestBody.role);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddOrganizationMemberRequestBody {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddOrganizationMemberRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddOrganizationMemberRequestBody is not found in the empty JSON string", AddOrganizationMemberRequestBody.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddOrganizationMemberRequestBody.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddOrganizationMemberRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
