...
public class InstanceDbTokenApi {
     ...
     */
    public okhttp3.Call getDbTokenInstancesInstanceIdDbTokenGetCall(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getDbTokenInstancesInstanceIdDbTokenGetValidateBeforeCall(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object getDbTokenInstancesInstanceIdDbTokenGet(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization) throws ApiException {
     ...
     */
    public ApiResponse<Object> getDbTokenInstancesInstanceIdDbTokenGetWithHttpInfo(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization) throws ApiException {
     ...
     */
    public okhttp3.Call getDbTokenInstancesInstanceIdDbTokenGetAsync(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback<Object> _callback) throws ApiException {
