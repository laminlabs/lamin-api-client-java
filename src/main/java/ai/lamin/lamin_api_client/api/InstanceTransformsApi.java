...
public class InstanceTransformsApi {
     ...
     */
    public okhttp3.Call createTransformInstancesInstanceIdTransformsPostCall(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull CreateTransformRequestBody createTransformRequestBody, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createTransformInstancesInstanceIdTransformsPostValidateBeforeCall(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull CreateTransformRequestBody createTransformRequestBody, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object createTransformInstancesInstanceIdTransformsPost(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull CreateTransformRequestBody createTransformRequestBody, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization) throws ApiException {
     ...
     */
    public ApiResponse<Object> createTransformInstancesInstanceIdTransformsPostWithHttpInfo(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull CreateTransformRequestBody createTransformRequestBody, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization) throws ApiException {
     ...
     */
    public okhttp3.Call createTransformInstancesInstanceIdTransformsPostAsync(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull CreateTransformRequestBody createTransformRequestBody, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback<Object> _callback) throws ApiException {
