...
public class InstanceFormsApi {
     ...
     */
    public okhttp3.Call registerFormInstancesInstanceIdFormsPostCall(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull RegisterFormRequest registerFormRequest, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call registerFormInstancesInstanceIdFormsPostValidateBeforeCall(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull RegisterFormRequest registerFormRequest, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object registerFormInstancesInstanceIdFormsPost(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull RegisterFormRequest registerFormRequest, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization) throws ApiException {
     ...
     */
    public ApiResponse<Object> registerFormInstancesInstanceIdFormsPostWithHttpInfo(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull RegisterFormRequest registerFormRequest, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization) throws ApiException {
     ...
     */
    public okhttp3.Call registerFormInstancesInstanceIdFormsPostAsync(@javax.annotation.Nonnull UUID instanceId, @javax.annotation.Nonnull RegisterFormRequest registerFormRequest, @javax.annotation.Nullable UUID spaceId, @javax.annotation.Nullable String authorization, final ApiCallback<Object> _callback) throws ApiException {
