...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.Account.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.AwsStsCredentials.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.BatchSyncLinksBody.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.DbTokenResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.Dimension.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.ErrorDetail.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.ExecuteFunctionRequestBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.ExportRecordsRequestBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.ExternalJwtExchangeRequest.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.SetSecretRequestBody.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.StatisticsResponse.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.StorageAccessibility.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new ai.lamin.lamin_api_client.model.StorageCredentialsResponse.CustomTypeAdapterFactory());
