...
import ai.lamin.lamin_api_client.auth.Authentication;
import ai.lamin.lamin_api_client.auth.HttpBasicAuth;
import ai.lamin.lamin_api_client.auth.HttpBearerAuth;
import ai.lamin.lamin_api_client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://aws.us-east-1.lamin.ai/api";
    ...
    public ApiClient() {
        ...
        authentications.put("LaminAccessToken", new HttpBearerAuth("bearer"));
     ...
     * @return a {@link ai.lamin.lamin_api_client.ApiClient} object
     */
    ...
    */
     ...
     * @throws ai.lamin.lamin_api_client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ai.lamin.lamin_api_client.ApiException If fail to serialize the given object
     */
     ...
     * @throws ai.lamin.lamin_api_client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ai.lamin.lamin_api_client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ai.lamin.lamin_api_client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ai.lamin.lamin_api_client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ai.lamin.lamin_api_client.ApiException If fails to update the parameters
     */
     ...
     * @throws ai.lamin.lamin_api_client.ApiException If fail to serialize the request body object into a string
     */
