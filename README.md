...
Lamin API
- API version: 0.1.0
  - Build date: 2026-07-28T08:40:00.923466696+02:00[Europe/Brussels]
...
```groovy
  ...
  dependencies {
     implementation "ai.lamin:lamin-api-client:0.0.9"
  }
```
...
* `target/lamin-api-client-0.0.9.jar`
* `target/lib/*.jar`
...
*AccountsApi* | [**getCentralJwtAccountJwtPost**](docs/AccountsApi.md#getCentralJwtAccountJwtPost) | **POST** /account/jwt | Get Central Jwt
...
*InstanceArtifactsApi* | [**createArtifactSqlAsyncInstancesInstanceIdArtifactsCreateSqlAsyncPost**](docs/InstanceArtifactsApi.md#createArtifactSqlAsyncInstancesInstanceIdArtifactsCreateSqlAsyncPost) | **POST** /instances/{instance_id}/artifacts/create-sql-async | Create Artifact Sql Async
*InstanceArtifactsApi* | [**createArtifactSqlInstancesInstanceIdArtifactsCreateSqlPost**](docs/InstanceArtifactsApi.md#createArtifactSqlInstancesInstanceIdArtifactsCreateSqlPost) | **POST** /instances/{instance_id}/artifacts/create-sql | Create Artifact Sql
