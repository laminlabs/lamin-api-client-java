...
FastAPI
- API version: 0.1.0
  - Build date: 2025-03-21T10:25:37.689436234+01:00[Europe/Berlin]
...
```xml
<dependency>
  <groupId>com.github.data-intuitive</groupId>
...
```groovy
  ...
  dependencies {
     implementation "com.github.data-intuitive:lamin-api-client-java:0.0.1"
  }
```
...
import com.github.data_intuitive.lamin_api_client_java.model.*;
