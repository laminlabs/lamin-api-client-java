...
FastAPI
- API version: 0.1.0
  - Build date: 2025-04-02T12:36:39.914083236+02:00[Europe/Brussels]
...
```groovy
  ...
  dependencies {
     implementation "ai.lamin:lamin-api-client-java:0.0.1"
  }
```
...
import ai.lamin.lamin_api_client_java.model.*;
